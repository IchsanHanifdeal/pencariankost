...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO kost (nama_kost, alamat, latitude, longitude) VALUES ('$namaKost', '$alamat', '$latitude', '$longitude')";
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card shadow">
                        <div class="card-header bg-gradient-primary shadow-primary border-0">
                            <h6 class="text-white text-uppercase mb-0">Tambah Lokasi Kost</h6>
                        </div>
